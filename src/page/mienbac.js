...
const destinations = [
    {
      ...
      description:
        "Vịnh Hạ Long, được UNESCO công nhận là Di sản Thiên nhiên Thế giới, nổi bật với hàng nghìn đảo đá vôi hùng vĩ giữa làn nước trong xanh. Điểm đến lý tưởng cho du khách yêu thích du thuyền, chèo kayak và khám phá hang động như Hang Sửng Sốt, Hang Luồn.",
      location: "https://maps.google.com/?q=Vịnh+Hạ+Long",
    },
    {
      name: "Sapa",
